        ...
        <Row>
                            ...
                            {[...Array(item.countInStock).keys()].map((x) => (
                              <option key={x + 1} value={x + 1}>
                                {x + 1}
                                    ...
                                    <Col>
                                    <Button type='button' variant='light' onClick={() => removeFromCartHandler(item.product)}><i className='fas fa-trash'></i></Button></Col>
                                </Row>
                            </ListGroup.Item>
                        ))}
                    </ListGroup>
            ...
            <Col md={4}>
                ...
                <Card>
                    <ListGroup variant='flush'>
                        <ListGroup.Item>
                            <h2>Subtotals ({cartItems.reduce((acc, item) => acc + item.qty, 0)}) items</h2>
